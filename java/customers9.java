...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("customers9.txt");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("customers9.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<body bgcolor=white><table border=1 width=1080 align=center>");
pout.println("<tr bgcolor=gray align=center><td>NO</td><td>customer9id</td><td>companyname</td><td>contactname</td><td>contacttitle</td><td>address</td></tr>");
