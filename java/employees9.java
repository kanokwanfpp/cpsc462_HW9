...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("employees9.txt");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("employees9.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<body bgcolor=white><table border=1 width=1080 align=center>");
pout.println("<tr bgcolor=gray align=center><td>NO</td><td>id_employeeid</td><td>firstname</td><td>lastname</td><td>title</td><td>birthdate</td></tr>");
